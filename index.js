...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-divi/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-divi -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-divi -o bitcore-lib-divi.js';
    }
